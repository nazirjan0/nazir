...
logo = '\nAuther   : Dark\nTelegram : @i4m_dark\nChannel  : Zed Cracker\nCreate   : @i4m_dark @Kak_Zed\nNote     : Nrxi am toola 10$\nCracked binnyamin binni\n--------------------------------------------------\n                                '
back = 0
successful = []
cpb = []
oks = []
id = []
os.system('clear')
os.system('figlet binyamin')
print '===================\nLoading... |'
time.sleep(0.1)
os.system('clear')
os.system('figlet Fucked dark')
print '===================\nLoading... /'
time.sleep(0.1)
os.system('clear')
os.system('figlet Fucked zed')
print '===================\nLoading... -'
time.sleep(0.1)
os.system('clear')
os.system('figlet binni')
print '===================\nLoading... |'
time.sleep(0.1)
os.system('clear')
...
time.sleep(0.1)
os.system('clear')
os.system('figlet binyamin binni')
print '==================='
